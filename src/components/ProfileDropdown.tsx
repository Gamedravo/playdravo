      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Card */}
            <div
              className="mx-auto w-full rounded-t-[28px] overflow-hidden flex flex-col"
              style={{
                ...
                <div className="px-3 pb-2">
                  {menuItems.map((item) => (
                    <motion.button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-3 rounded-2xl mb-0.5 transition-colors ${
                        item.danger ? 'active:bg-red-500/8' : 'active:bg-white/5'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-[13px] font-semibold ${item.danger ? 'text-red-400' : 'text-white/70'}`}>
                          {item.label}
                        </span>
                      </div>
