...
export const GAMES: Game[] = [
  ...
  // ── Bus Simulator Series (madkidgames.com) ────────────────────────────
  {
    id: 'bus-simulator-pro-2',
    title: 'Bus Simulator PRO 2',
    category: 'Simulator',
    url: 'https://www.madkidgames.com/full/bus-simulator-pro-2',
    thumbnail: 'https://www.madkidgames.com/games/bus-simulator-pro-2/thumb_1.jpg',
    description: 'Take the wheel of a real bus and drive passengers through busy city streets! Pick up and drop off riders on schedule in this realistic 3D bus driving simulator.',
    rating: 4.6,
    plays: 3800000,
    authorUid: 'curated',
    ...
    isHot: true,
    isTop: false,
    tags: ['Simulator', 'Driving', '1 Player', '3d', 'Bus', 'City'],
    developer: 'MadKid Games',
    publisher: 'MadKid Games',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
    orientation: 'landscape',
    embedCompatibility: 'full',
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/bus-simulator-ultimate/thumb_1.jpg',
    description: 'Experience the ultimate bus driving challenge! Navigate through diverse routes, manage passengers, and master realistic controls in this premium bus simulator.',
    rating: 4.7,
    plays: 4200000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/coach-bus-simulator-17/thumb_1.jpg',
    description: 'Drive a long-distance coach bus across highways and cities! Transport passengers safely to their destinations while managing fuel and time in this realistic simulator.',
    rating: 4.4,
    plays: 2600000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Simulator', 'Driving', '1 Player', '3d', 'Bus', 'Highway'],
    developer: 'MadKid Games',
    publisher: 'MadKid Games',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/coach-bus-simulator/thumb_1.jpg',
    description: 'Get behind the wheel of a coach bus and master long-haul routes! Pick up passengers at stops, follow road rules, and deliver everyone safely on time.',
    rating: 4.3,
    plays: 2200000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/bus-simulator-17/thumb_1.jpg',
    description: 'Drive buses through bustling city traffic in Bus Simulator 17! Stop at bus stops, collect fares, and navigate urban routes in this immersive driving experience.',
    rating: 4.4,
    plays: 3100000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
  ...
  // ── Truck Simulator Series (madkidgames.com) ──────────────────────────
  {
    id: 'euro-truck-driver-2018',
    title: 'Euro Truck Driver 2018',
    category: 'Simulator',
    url: 'https://www.madkidgames.com/full/euro-truck-driver-2018',
    thumbnail: 'https://www.madkidgames.com/games/euro-truck-driver-2018/thumb_1.jpg',
    description: 'Hit the open road across Europe in a massive semi-truck! Haul cargo through realistic city streets and highways, upgrade your rig, and build your trucking empire.',
    rating: 4.6,
    plays: 4500000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Simulator', 'Driving', '1 Player', '3d', 'Truck', 'Highway'],
    developer: 'MadKid Games',
    publisher: 'MadKid Games',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/truck-simulator-usa-classic/thumb_1.jpg',
    description: 'Drive iconic American big rigs across the USA! Deliver loads through diverse landscapes from deserts to mountains in this classic open-road trucking simulator.',
    rating: 4.5,
    plays: 3700000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/truckers-of-europe-2/thumb_1.jpg',
    description: 'Become a top trucker across the roads of Europe! Transport valuable cargo between cities, hire drivers, and grow your logistics company in this deep truck simulator.',
    rating: 4.7,
    plays: 5100000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/truck-simulator-pro-2/thumb_1.jpg',
    description: 'The ultimate professional trucking experience! Master realistic physics, customize your truck, and tackle challenging long-haul routes in Truck Simulator PRO 2.',
    rating: 4.8,
    plays: 6200000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Simulator', 'Driving', '1 Player', '3d', 'Truck', 'Highway', 'Skill'],
    developer: 'MadKid Games',
    publisher: 'MadKid Games',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  // ── Verified Working Gameflare Games ─────────────────────────────────
  {
    id: 'tekken-3',
    title: 'Tekken 3',
    category: 'Fighting',
  ...
  // ── MadKidGames — Popular & Trending ─────────────────────────────────
  {
    id: 'mkd-airplane-flight-simulator-evo',
    ...
    description: 'Take the controls of a real aircraft and explore the skies in this ultra-realistic flight simulator. Land at airports, perform stunts, and master the cockpit.',
    rating: 4.9,
    plays: 18000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Simulator', 'Action', '3d', 'Flying', 'Airplane', '1 Player'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
    orientation: 'landscape',
    embedCompatibility: 'full',
  ...
  {
    id: 'mkd-traffic-rider',
    title: 'Traffic Rider',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/traffic-rider',
    thumbnail: 'https://www.madkidgames.com/games/traffic-rider/thumb_1.jpg',
    description: 'Hop on your motorbike and race through heavy traffic at high speed. Dodge cars, unlock bikes, and earn achievements in this addictive endless bike racer.',
    rating: 4.8,
    plays: 22000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Racing', 'Moto', 'Bike', '3d', '1 Player', 'Action', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-smashy-road-wanted',
    title: 'Smashy Road: Wanted',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/smashy-road-wanted',
    thumbnail: 'https://www.madkidgames.com/games/smashy-road-wanted/thumb_1.jpg',
    description: 'Escape the police in this explosive car-smashing open-world game! Collect cars, smash through everything, and rack up the highest wanted level possible.',
    rating: 4.8,
    plays: 20000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Racing', 'Action', '3d', 'Car', 'Driving', '1 Player', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-stick-war-legacy',
    title: 'Stick War: Legacy',
    category: 'Strategy',
    url: 'https://www.madkidgames.com/full/stick-war-legacy',
    thumbnail: 'https://www.madkidgames.com/games/stick-war-legacy/thumb_1.jpg',
    description: 'Command your stickman army to conquer the world of Inamorta! Build units, mine gold, and crush enemy empires in this legendary strategy-action game.',
    rating: 4.9,
    plays: 25000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Strategy', 'Action', 'Stickman', '1 Player', 'War', 'Battle'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-beat-the-boss-4',
    title: 'Beat the Boss 4',
    category: 'Action',
    url: 'https://www.madkidgames.com/full/beat-the-boss-4',
    thumbnail: 'https://www.madkidgames.com/games/beat-the-boss-4/thumb_1.jpg',
    description: 'Your boss is evil — destroy him with weapons, gadgets, and chaos! Unlock dozens of creative ways to unleash your rage in this wildly popular stress-relief game.',
    rating: 4.8,
    plays: 19000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Action', 'Casual', 'Fun', '1 Player', 'Rage', 'Stress'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-offroad-outlaws',
    title: 'Offroad Outlaws',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/offroad-outlaws',
    thumbnail: 'https://www.madkidgames.com/games/offroad-outlaws/thumb_1.jpg',
    description: 'Build and race extreme off-road trucks and buggies across rugged terrain. Customize your rig and conquer impossible mud trails and rock climbs.',
    rating: 4.8,
    plays: 16000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Racing', '3d', 'Driving', 'Car', '1 Player', 'Action', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-ultimate-car-driving-simulator',
    title: 'Ultimate Car Driving Simulator',
    category: 'Simulator',
    url: 'https://www.madkidgames.com/full/ultimate-car-driving-simulator',
    thumbnail: 'https://www.madkidgames.com/games/ultimate-car-driving-simulator/thumb_1.jpg',
    description: 'Drive the most powerful supercars through an open world in this ultimate driving simulator. Drift, race, and explore with stunning 3D graphics.',
    rating: 4.7,
    plays: 14000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: true,
    tags: ['Simulator', 'Driving', 'Car', '3d', '1 Player', 'Action', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-last-day-on-earth-survival',
    title: 'Last Day on Earth: Survival',
    category: 'Adventure',
    url: 'https://www.madkidgames.com/full/last-day-on-earth-survival',
    thumbnail: 'https://www.madkidgames.com/games/last-day-on-earth-survival/thumb_1.jpg',
    description: 'Survive a zombie apocalypse! Gather resources, build a base, craft weapons, and fight hordes of undead in this intense survival action game.',
    rating: 4.8,
    plays: 17000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Adventure', 'Survival', 'Zombie', 'Action', '1 Player', 'Horror', 'Strategy'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-mountain-climb-4x4',
    title: 'Mountain Climb 4x4',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/mountain-climb-4x4-car-drive',
    thumbnail: 'https://www.madkidgames.com/games/mountain-climb-4x4-car-drive/thumb_1.jpg',
    description: 'Push your 4x4 truck to the limits on extreme mountain terrain! Climb impossible slopes, conquer rocky hills, and don\'t let gravity beat you.',
    rating: 4.6,
    plays: 12000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Racing', 'Driving', 'Car', '3d', '1 Player', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-monster-truck-go',
    title: 'Monster Truck Go',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/monster-truck-go-racing-games',
    thumbnail: 'https://www.madkidgames.com/games/monster-truck-go-racing-games/thumb_1.jpg',
    description: 'Smash through tracks with monster trucks in this action-packed racing game! Perform tricks, crush cars, and race to the finish line.',
    rating: 4.7,
    plays: 11000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Racing', 'Truck', 'Action', '3d', '1 Player', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-stickman-destruction-3',
    title: 'Stickman Destruction 3',
    category: 'Action',
    url: 'https://www.madkidgames.com/full/stickman-destruction-3-heroes-ragdoll-game',
    thumbnail: 'https://www.madkidgames.com/games/stickman-destruction-3-heroes-ragdoll-game/thumb_1.jpg',
    description: 'Launch your stickman hero into total destruction! Hit ramps, crash through obstacles, and cause maximum chaos with satisfying ragdoll physics.',
    rating: 4.7,
    plays: 13000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Action', 'Stickman', 'Ragdoll', 'Physics', '1 Player', 'Fun', 'Arcade'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-stickman-world-battle',
    title: 'Stickman World Battle',
    category: 'Action',
    url: 'https://www.madkidgames.com/full/stickman-world-battle',
    thumbnail: 'https://www.madkidgames.com/games/stickman-world-battle/thumb_1.jpg',
    description: 'Lead your stickman army into epic world battles! Command troops, upgrade your soldiers, and conquer enemy territories in this epic action-strategy game.',
    rating: 4.7,
    plays: 10000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Action', 'Strategy', 'Stickman', 'Battle', 'War', '1 Player'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-beat-the-boss-2',
    title: 'Beat the Boss 2',
    category: 'Action',
    url: 'https://www.madkidgames.com/full/beat-the-boss-2',
    thumbnail: 'https://www.madkidgames.com/games/beat-the-boss-2/thumb_1.jpg',
    description: 'Unleash your frustration on your annoying boss in this hilarious stress-relief game. Use swords, guns, explosives, and more to punish your boss!',
    rating: 4.7,
    plays: 15000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Action', 'Casual', 'Fun', '1 Player', 'Rage'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/granny/thumb_1.jpg',
    description: 'You\'re trapped in Granny\'s house — escape without getting caught! Solve puzzles, find hidden objects, and sneak past the terrifying Granny in 5 days.',
    rating: 4.8,
    plays: 21000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Adventure', 'Horror', 'Puzzle', 'Survival', '1 Player', 'Scary'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-squad-shooter',
    title: 'Squad Shooter',
    category: 'Action',
    url: 'https://www.madkidgames.com/full/squad-shooter',
    thumbnail: 'https://www.madkidgames.com/games/squad-shooter/thumb_1.jpg',
    description: 'Lead your squad of soldiers against waves of enemies in this intense top-down shooter. Upgrade weapons, unlock new squad members, and dominate the battlefield.',
    rating: 4.7,
    plays: 9000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Action', 'Shooter', 'Strategy', '1 Player', 'Military', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-car-racing-realistic',
    title: 'Car Racing: Realistic Simulator',
    category: 'Racing',
    url: 'https://www.madkidgames.com/full/car-racing-realistic-car-simulator',
    thumbnail: 'https://www.madkidgames.com/games/car-racing-realistic-car-simulator/thumb_1.jpg',
    description: 'Experience hyper-realistic car racing with stunning 3D physics. Choose from a lineup of powerful cars and race on real-world inspired tracks.',
    rating: 4.8,
    plays: 13000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Racing', '3d', 'Car', 'Driving', '1 Player', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/short-ride/thumb_1.jpg',
    description: 'Survive the shortest — and most brutal — bike ride ever! Navigate deadly obstacle courses on your bicycle without getting obliterated by traps and hazards.',
    rating: 4.6,
    plays: 10000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Racing', 'Bike', 'Arcade', 'Fun', 'Physics', '1 Player'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'mkd-cargo-truck-simulator',
    title: 'Cargo Truck Simulator',
    category: 'Simulator',
    url: 'https://www.madkidgames.com/full/cargo-truck-simulator',
    thumbnail: 'https://www.madkidgames.com/games/cargo-truck-simulator/thumb_1.jpg',
    description: 'Haul heavy cargo across challenging roads in this realistic truck simulator. Manage your load balance and navigate tight mountain passes and city streets.',
    rating: 4.6,
    plays: 8000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Simulator', 'Truck', 'Driving', '3d', '1 Player', 'Mobile'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
  ...
  },
  {
    ...
    thumbnail: 'https://www.madkidgames.com/games/pegidle/thumb_1.jpg',
    description: 'Drop balls, hit pegs, and watch your score skyrocket in this addictive idle-pachinko hybrid. The more pegs you hit, the more you earn — pure satisfying fun.',
    rating: 4.7,
    plays: 9000000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Casual', 'Idle', 'Arcade', 'Fun', '1 Player', 'Mobile', 'Clicker'],
    developer: 'MadKidGames',
    publisher: 'MadKidGames',
    mobileOptimization: 'touch-friendly',
    fullscreenSupport: true,
