...
export const GAMES: Game[] = [
  ...
  // ── More Girls Games (verified kiz10 + Gameflare embeds) ─────────────
  {
    ...
    category: 'Girls',
    url: 'https://www.gameflare.com/embed/talking-tom-gold-run/',
    thumbnail: 'https://data.gameflare.com/games/9053/pWCroSLhiwBvgs-400-300.jpg',
    description: 'Run with Talking Tom and his friends! Collect gold, dodge obstacles and outrun the robber in this fun endless runner from the beloved Talking Tom universe.',
    rating: 4.6, plays: 18000000, authorUid: 'curated', createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true, isTop: true,
    tags: ['Girls', 'Casual', '1 Player', 'Endless Runner', 'Cute', 'Funny'],
    developer: 'Outfit7', publisher: 'Gameflare', mobileOptimization: 'responsive',
  ...
  },
  {
    ...
    title: 'Cooking Mama',
    category: 'Girls',
    url: 'https://www.gameflare.com/embed/cooking-mama/',
    thumbnail: 'https://data.gameflare.com/games/1287/ScZbvD19SChrrL-400-300.jpg',
    description: 'Cook with Mama! Follow step-by-step recipes, chop, fry, mix and bake your way through dozens of dishes in the classic beloved cooking game. Don\'t burn it!',
    rating: 4.7, plays: 22000000, authorUid: 'curated', createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true, isTop: true,
    tags: ['Girls', 'Casual', '1 Player', 'Cooking', 'Cute', 'Family'],
    developer: 'Office Create', publisher: 'Gameflare', mobileOptimization: 'responsive',
    fullscreenSupport: true, orientation: 'landscape', embedCompatibility: 'full',
    validationState: 'Verified Working', lastVerified: '2026-06-07T00:00:00.000Z',
  ...
  // ── Mixed New Arrivals (verified Gameflare embeds) ────────────────────
  {
    id: 'cat-simulator-my-pets',
    title: 'Cat Simulator: My Pets',
    category: 'Girls',
    url: 'https://www.gameflare.com/embed/cat-simulator-my-pets/',
    thumbnail: 'https://data.gameflare.com/games/10826/7iqoaSZdVVRVyb-400-300.jpg',
    description: 'Live life as a cat! Explore your home, play with toys, knock things off shelves and interact with other pets in this super cute cat life simulator.',
    rating: 4.5,
    plays: 6700000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Girls', 'Casual', '1 Player', 'Simulator', 'Animals', 'Cute'],
    developer: 'Gameflare',
    publisher: 'Gameflare',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'snake-and-ladders-multiplayer',
    title: 'Snake and Ladders Multiplayer',
    category: 'Casual',
    url: 'https://www.gameflare.com/embed/snake-and-ladders-multiplayer/',
    thumbnail: 'https://data.gameflare.com/games/8811/5Ha7VZFCU1EmIi-400-300.jpg',
    description: 'The classic board game goes online! Roll the dice and race to the finish, climb ladders and dodge snakes in this colourful multiplayer version of the timeless favourite.',
    rating: 4.4,
    plays: 8100000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: false,
    isTop: false,
    tags: ['Casual', 'Multiplayer', '2 Player', 'Board', 'Dice', 'Family'],
    developer: 'Gameflare',
    publisher: 'Gameflare',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'sprunki-among-us-mod',
    title: 'Sprunki Among Us Mod',
    category: 'Casual',
    url: 'https://www.gameflare.com/embed/sprunki-among-us-mod/',
    thumbnail: 'https://data.gameflare.com/games/10579/83ojG7SM5zrhy7-400-300.jpg',
    description: 'Combine the viral Sprunki music maker with Among Us characters! Mix and match crewmate beats, create unique tracks and vibe to the sounds of the space station.',
    rating: 4.6,
    plays: 9400000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Casual', '1 Player', 'Music', 'Creative', 'Funny'],
    developer: 'Gameflare',
    publisher: 'Gameflare',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'sprunki-skibidi-toilet-2-0',
    title: 'Sprunki Skibidi Toilet 2.0',
    category: 'Casual',
    url: 'https://www.gameflare.com/embed/sprunki-skibidi-toilet-2-0/',
    thumbnail: 'https://data.gameflare.com/games/10537/OKmsHaqByqBUxe-400-300.jpg',
    description: 'The wildest crossover on the internet! Mix Skibidi Toilet characters with Sprunki beats to create chaotic, hilarious music mashups. Pure internet culture in game form.',
    rating: 4.5,
    plays: 11200000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: true,
    tags: ['Casual', '1 Player', 'Music', 'Funny', 'Creative'],
    developer: 'Gameflare',
    publisher: 'Gameflare',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
  ...
  {
    id: 'sprunki-rareshifted',
    title: 'Sprunki Rareshifted',
    category: 'Casual',
    url: 'https://www.gameflare.com/embed/sprunki-rareshifted/',
    thumbnail: 'https://data.gameflare.com/games/11325/kSyTsO7f5G3543-400-300.jpg',
    description: 'A rare and mysterious Sprunki phase with unique characters and haunting soundscapes. Discover hidden combinations and unlock eerie musical sequences in this fan-favourite mod.',
    rating: 4.7,
    plays: 7300000,
    authorUid: 'curated',
    createdAt: '2026-06-07T00:00:00.000Z',
    isHot: true,
    isTop: false,
    tags: ['Casual', '1 Player', 'Music', 'Creative', 'Horror'],
    developer: 'Gameflare',
    publisher: 'Gameflare',
    mobileOptimization: 'responsive',
    fullscreenSupport: true,
