...
const CUSTOM_GD_GAMES: Game[] = [
  {
    ...
    description: 'The iconic duo returns with friends in an all-new co-op adventure.',
    rating: 4.8, plays: 1850000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  },
  {
    id: 'gd-fireboy-watergirl-1',
    title: 'Fireboy and Watergirl 1: Forest Temple',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/a55c9cc9c21e4fc683c8c6857f3d0c75/',
    thumbnail: 'https://img.gamedistribution.com/a55c9cc9c21e4fc683c8c6857f3d0c75/512x384.jpg',
    description: 'Guide Fireboy and Watergirl through the mysterious Forest Temple in this classic co-op platformer.',
    rating: 4.9, plays: 3200000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle', 'Classic'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  ...
  {
    id: 'gd-fireboy-watergirl-2',
    title: 'Fireboy and Watergirl 2: Light Temple',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/383ad09b92c7446b9113cccc29630517/',
    thumbnail: 'https://img.gamedistribution.com/383ad09b92c7446b9113cccc29630517/512x384.jpg',
    description: 'Use mirrors and light beams to solve puzzles in the ancient Light Temple.',
    rating: 4.8, plays: 2700000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
  ...
  {
    id: 'gd-fireboy-watergirl-3',
    title: 'Fireboy and Watergirl 3: Ice Temple',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/f3a6e1ac0a77412289cbac47658b2b68/',
    thumbnail: 'https://img.gamedistribution.com/f3a6e1ac0a77412289cbac47658b2b68/512x384.jpg',
    description: 'Navigate icy platforms and freezing traps in the Ice Temple.',
    rating: 4.7, plays: 2400000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
  ...
  {
    id: 'gd-fireboy-watergirl-4',
    title: 'Fireboy and Watergirl 4: Crystal Temple',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/3790681b69584409b7f681a8e400102d/',
    thumbnail: 'https://img.gamedistribution.com/3790681b69584409b7f681a8e400102d/512x384.jpg',
    description: 'Crystals and clones await in the sparkling Crystal Temple.',
    rating: 4.7, plays: 2100000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
  ...
  {
    id: 'gd-fireboy-watergirl-5',
    title: 'Fireboy and Watergirl 5: Elements',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/03f124074b0049f89fdace0cacf8ead5/',
    thumbnail: 'https://img.gamedistribution.com/03f124074b0049f89fdace0cacf8ead5/512x384.jpg',
    description: 'Master the power of all four elements in this epic sequel.',
    rating: 4.8, plays: 2300000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
  ...
  },
  {
    ...
    thumbnail: 'https://img.gamedistribution.com/56da8a54fe204845b34ccff750d4a60b/512x384.jpg',
    description: 'Enter an enchanted fairy tale world full of magic and new challenges.',
    rating: 4.7, plays: 1900000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Adventure', '2 Player', 'Multiplayer', 'Puzzle'],
    developer: 'Oslo Albet', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
  ...
  {
    id: 'gd-meme-myth-wukong',
    title: 'Meme Myth: Wukong',
    category: 'Action',
    url: 'https://html5.gamedistribution.com/e4af90c070cf499da371b44232a6aaca/',
    thumbnail: 'https://img.gamedistribution.com/e4af90c070cf499da371b44232a6aaca/512x384.jpg',
    description: 'Play as the legendary Monkey King in this hilarious meme-packed action adventure.',
    rating: 4.5, plays: 780000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, tags: ['Action', 'Adventure', 'Fun'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  },
  {
    id: 'gd-football-legends-2026',
    title: 'Football Legends 2026',
    category: 'Sports',
    url: 'https://html5.gamedistribution.com/13eabea86f7c4cd993a156258420e9ec/',
    thumbnail: 'https://img.gamedistribution.com/13eabea86f7c4cd993a156258420e9ec/512x384.jpg',
    description: 'Compete with legendary footballers in this fast-paced soccer showdown.',
    rating: 4.6, plays: 1100000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, isTop: true, tags: ['Sports', 'Football', 'Soccer', '2 Player', 'Multiplayer'],
    developer: 'MadPuffers', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  },
  {
    id: 'gd-geometry-vibes',
    title: 'Geometry Vibes',
    category: 'Arcade',
    url: 'https://html5.gamedistribution.com/b3507beea8bc46638a6d5e7c768a8202/',
    thumbnail: 'https://img.gamedistribution.com/b3507beea8bc46638a6d5e7c768a8202/512x384.jpg',
    description: 'Race through a neon geometry world in this rhythm-fueled arcade challenge.',
    rating: 4.4, plays: 650000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: false, tags: ['Arcade', 'Skill', 'Rhythm'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  ...
  {
    id: 'gd-world-cup-soccer-caps',
    title: 'World Cup Soccer Caps',
    category: 'Sports',
    url: 'https://html5.gamedistribution.com/040ff13a2a9f44b98009750960a523ae/',
    thumbnail: 'https://img.gamedistribution.com/040ff13a2a9f44b98009750960a523ae/512x384.jpg',
    description: 'Flick your cap in this fun and addictive World Cup table soccer game.',
    rating: 4.3, plays: 520000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: false, tags: ['Sports', 'Football', 'Soccer', '2 Player'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  },
  {
    ...
    title: 'Block Escape',
    category: 'Puzzle',
    url: 'https://html5.gamedistribution.com/9ffaf2fb134844958788642d2f76c6cd/',
    thumbnail: 'https://img.gamedistribution.com/9ffaf2fb134844958788642d2f76c6cd/512x384.jpg',
    description: 'Slide blocks and find the escape route in this satisfying puzzle game.',
    rating: 4.4, plays: 430000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: false, tags: ['Puzzle', 'Logic', 'Brain'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'touch-friendly', fullscreenSupport: true, orientation: 'portrait',
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  },
  {
    id: 'gd-family-simulator-beach',
    title: 'Family Simulator Beach Games',
    category: 'Simulator',
    url: 'https://html5.gamedistribution.com/2f628fd6df1c459ea9a6295b768bfb71/',
    thumbnail: 'https://img.gamedistribution.com/2f628fd6df1c459ea9a6295b768bfb71/512x384.jpg',
    description: 'Enjoy a sunny beach day with your virtual family in this laid-back simulator.',
    rating: 4.2, plays: 380000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: false, tags: ['Simulator', 'Family', 'Casual', 'Fun'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  ...
  {
    id: 'gd-obby-escape-tsunami-brainrot',
    title: 'Obby Escape from Tsunami Brainrot',
    category: 'Adventure',
    url: 'https://html5.gamedistribution.com/539362ed8a7b48a2be6ff8d90b8d6f3a/',
    thumbnail: 'https://img.gamedistribution.com/539362ed8a7b48a2be6ff8d90b8d6f3a/512x384.jpg',
    description: 'Dodge the rising tsunami and outrun chaos in this wild Roblox-style obby.',
    rating: 4.5, plays: 920000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: true, tags: ['Adventure', 'Action', 'Parkour', 'Fun'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
  ...
  {
    id: 'gd-parking-fury-3d-night-city',
    title: 'Parking Fury 3D: Night City',
    category: 'Driving',
    url: 'https://html5.gamedistribution.com/13d99dac275842e1a64a13332962fbd1/',
    thumbnail: 'https://img.gamedistribution.com/13d99dac275842e1a64a13332962fbd1/512x384.jpg',
    description: 'Park your car in tight spots across a neon-lit city in 3D.',
    rating: 4.3, plays: 710000, authorUid: 'gamedistribution', createdAt: '2026-01-01T00:00:00.000Z',
    isHot: false, tags: ['Driving', 'Racing', '3d', 'Simulator'],
    developer: 'GameDistribution', publisher: 'GameDistribution',
    mobileOptimization: 'responsive', fullscreenSupport: true,
    embedCompatibility: 'full', validationState: 'Verified Working',
    adsInjected: false, popupRisk: false, redirectRisk: false,
