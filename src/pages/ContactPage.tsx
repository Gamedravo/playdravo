...
export function ContactPage({ isDarkMode, t }: ContactPageProps) {
  ...
  return (
    ...
    <SEO
      ...
      description="Contact the GameDravo team for support, partnerships, game submissions, or general enquiries. We're here to help."
      canonicalUrl="https://gamedravo.com/contact"
    />
